...
const Button = ({
  ...
  const commonClasses = `p-2 w-32 rounded-3xl border border-trasparent bg-${variant} ${className} text-primary transition-all hover:bg-primary hover:text-secondary hover:border-secondary hover:border hover:scale-110 active:scale-95`;
